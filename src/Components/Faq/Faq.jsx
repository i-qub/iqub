...
export default function Faq() {
  ...
  return (
    <FAQ className="pointer">
      ...
      <div className="qn-div" onClick={()=>setQn([false,false,false,false,false,true,false,false,false])}><span className="qn"><span className="inner">{qn[5]?"-":"+"}</span> Lorem ipsum dolor sit amet?</span>
